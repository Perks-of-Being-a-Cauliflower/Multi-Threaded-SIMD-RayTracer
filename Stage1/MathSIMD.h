// renamed, and slightly altered, version of avx_mathfun_tweaked.h
// from: https://github.com/nlguillemot/CppSPMD/blob/master/src/common/avx_mathfun_tweaked.h

// defines the following maths functions that are roughly equivalent to their trig counterparts:
// - log256_ps 
// - exp256_ps
// - pow256_ps
// - sin256_ps
...
// if you get warnings about this not using AVX2 correctly, follow this guide to tell the compiler to be better:
...
ALIGN32_BEG typedef union imm_xmm_union {
	__m256i imm;
	__m128i xmm[2];
} imm_xmm_union ALIGN32_END;
...
static inline __m256i mm256_##fn(__m256i x, int a) \
{ \
...
#pragma message("Using SSE2 to perform AVX2 bitshift ops (Try turning on /arch:AVX2 in MSVC)")
AVX2_BITOP_USING_SSE2(slli_epi32)
AVX2_BITOP_USING_SSE2(srli_epi32)

#define AVX2_INTOP_USING_SSE2(fn) \
static inline __m256i mm256_##fn(__m256i x, __m256i y) \
{ \
...
#pragma message("Using SSE2 to perform AVX2 integer ops (Try turning on /arch:AVX2 in MSVC)")
...
#else
#define mm256_slli_epi32 _mm256_slli_epi32
#define mm256_srli_epi32 _mm256_srli_epi32
#define mm256_and_si128 _mm256_and_si128 
#define mm256_andnot_si128 _mm256_andnot_si128 
#define mm256_cmpeq_epi32 _mm256_cmpeq_epi32 
#define mm256_sub_epi32 _mm256_sub_epi32 
#define mm256_add_epi32 _mm256_add_epi32
#endif /* __AVX2__ */
...
return NaN for x <= 0
*/
INLINING_SWITCH __m256 log256_ps(__m256 x) {
	__m256i imm0;
	...
	imm0 = mm256_srli_epi32(_mm256_castps_si256(x), 23);
	...
	imm0 = mm256_sub_epi32(imm0, *(__m256i*)_pi32_256_0x7f);
...
INLINING_SWITCH __m256 exp256_ps(__m256 x) {
	...
	imm0 = mm256_add_epi32(imm0, *(__m256i*)_pi32_256_0x7f);
	imm0 = mm256_slli_epi32(imm0, 23);
...
inline __m256 sin256_ps(__m256 x) { // any x
	...
	*/
	...
	imm2 = mm256_cmpeq_epi32(imm2, *(__m256i*)_pi32_256_0);
#else
...
INLINING_SWITCH __m256 cos256_ps(__m256 x) { // any x
	...
	imm2 = _mm256_and_si256(imm2, *(__m256i*)_pi32_256_inv1);
	y = _mm256_cvtepi32_ps(imm2);
	imm2 = mm256_sub_epi32(imm2, *(__m256i*)_pi32_256_2);
...
INLINING_SWITCH void sincos256_ps(__m256 x, __m256 *s, __m256 *c) {
...
#ifdef __AVX2__
	imm4 = mm256_sub_epi32(imm4, *(__m256i*)_pi32_256_2);
	imm4 = _mm256_andnot_si256(imm4, *(__m256i*)_pi32_256_4);
	imm4 = mm256_slli_epi32(imm4, 29);
#else
...
INLINING_SWITCH __m256 pow256_ps(__m256 x, __m256 y) {
	return exp256_ps(_mm256_mul_ps(log256_ps(x), y));
}
