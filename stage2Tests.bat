...
Release\Stage2.exe -runs 1 -blockSize 8 -size 8 8 -samples 1 -threads 1 -output Outputs/stage2_04.bmp -input Scenes/dudes.txt 
...
Release\Stage2.exe -runs 1 -blockSize 16 -size 256 256 -samples 1 -output Outputs/stage2_09.bmp -input Scenes/dudes.txt 
...
Release\Stage2.exe -runs 1 -blockSize 16 -size 256 256 -samples 2 -output Outputs/stage2_14.bmp -input Scenes/dudes.txt 
